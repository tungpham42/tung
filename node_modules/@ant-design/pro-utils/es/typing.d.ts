 ...
 * @param color 颜色选择器
 */
export declare type ProFieldValueType = 'text' | 'password' | 'money' | 'textarea' | 'option' | 'date' | 'dateWeek' | 'dateMonth' | 'dateQuarter' | 'dateYear' | 'dateRange' | 'dateTimeRange' | 'dateTime' | 'time' | 'timeRange' | 'select' | 'checkbox' | 'rate' | 'radio' | 'radioButton' | 'index' | 'indexBorder' | 'progress' | 'percent' | 'digit' | 'digitRange' | 'second' | 'avatar' | 'code' | 'switch' | 'fromNow' | 'image' | 'jsonCode' | 'cascader' | 'treeSelect' | 'color';
...
export declare type ProSchema<Entity = Record<string, any>, ExtraProps = unknown, ComponentsType = ProSchemaComponentTypes, ValueType = 'text', ExtraFormItemProps = unknown> = {
    ...
    fieldProps?: ((form: FormInstance<any>, config: ProSchema<Entity, ExtraProps> & {
        ...
        rowIndex: number;
        entity: Entity;
    }) => ProSchemaFieldProps<ValueType>) | ProSchemaFieldProps<ValueType>;
