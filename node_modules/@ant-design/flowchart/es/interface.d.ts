...
import { IGraphCommandService, IModelService, NsGraph, IPosition, NsJsonSchemaForm, IToolbarLayout, IAppDestory, IAppConfigReady } from '@antv/xflow';
...
export declare type Command = 'undo-cmd' | 'redo-cmd' | 'front-node' | 'back-node' | 'save-graph-data' | 'multi-select' | 'add-group' | 'delete-group' | 'graph-toggle-multi-select' | 'graph-copy-selection' | 'graph-paste-selection';
